...
$sql="insert into member values('','".$_POST['member_user']."','".md5($_POST['member_password'])."')";
$result=mysql_query($sql)or die(mysql_error());
if($result)
echo "<script>alert('注册成功,马上进入主页面');location='member.php';</script>";
else
{
...
<form id="theForm" name="theForm" method="post" action="" onSubmit="return chk(this)" runat="server" style="margin-bottom:0px;">
  <table width="350" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#B3B3B3">
    <tr>
      <td colspan="2" align="center" bgcolor="#EBEBEB">注册&nbsp;&nbsp;以下打“*”为必填项</td>
    </tr>
    <tr>
...
<table width="350" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#B3B3B3">
  <tr>
    <td colspan="2" align="center" bgcolor="#EBEBEB" class="font">管理员登陆</td>
  </tr>
    <tr>
    ...
    <tr>
    <td colspan="2" align="center" valign="top" bgcolor="#FFFFFF" class="font"><input name="submit2" type="submit" value="登录"/>
  </tr>
</table>
</form>
<?php } ?>
